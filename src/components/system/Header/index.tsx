        ...
        <>
            <div className="flex justify-end items-end py-4 border-b border-gray-300 w-full">
                <div className="px-5 flex items-center gap-5">
                    ...
                    <Image className="w-9 h-9 rounded-full aspect-square object-cover" src="/images/user.jpg" width={100} height={100} alt="foto do restaurante" />
                </div>
            </div>

            {/* <div className="flex flex-col gap-3 p-4 border border-gray-300 rounded-lg max-w-80 w-full fixed top-16 bg-white right-4">
